...
[`envelope(...)`](/docs/reference/chart/util/envelope) weaves between two boundary curves. Both curves must
...
[`rain(...)`](/docs/reference/chart/util/rain) generates a list of short `AirCrush` notes across a time range.
