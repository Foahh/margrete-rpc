...
`ease_x` and `ease_h` accept built-in easing names, [`Easing`](/docs/reference/chart/util/easing/Easing)
objects, or custom callables. See [Easings](/docs/advanced/easings) for the full list and custom easing rules.
