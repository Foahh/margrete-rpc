...
Open a transaction, modify the chart, then leave the `with{:py}` block.
...
2. **Parse** - The Python API converts [`RawNote`](/docs/reference/chart/notes/raw/RawNote) to [`Note`](/docs/reference/chart/notes/shared/Note) objects such as [`Tap`](/docs/reference/chart/notes/ground/Tap)
...
By default, the Python API will parse recognized [`RawNote`](/docs/reference/chart/notes/raw/RawNote) to [`Note`](/docs/reference/chart/notes/shared/Note) objects such as [`Tap`](/docs/reference/chart/notes/ground/Tap) or [`Slide`](/docs/reference/chart/notes/long/Slide). If the
