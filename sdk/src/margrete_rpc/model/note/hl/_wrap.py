...
def _copy_joint(builder: _JointHost, child: LLNote, placed_kind: LongAttr) -> None:
...
def _wrap_attached_air_note(note: LLNote) -> Air | AirSlide | AirHold:
...
def _ensure_air_only_on_end(child: LLNote, is_final: bool) -> None:
