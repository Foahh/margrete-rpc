...
macro_rules! mp_guid {
    ($l:expr_2021, $w1:expr_2021, $w2:expr_2021, $b1:expr_2021, $b2:expr_2021, $b3:expr_2021, $b4:expr_2021, $b5:expr_2021, $b6:expr_2021, $b7:expr_2021, $b8:expr_2021) => {
        MpGuid::from_fields($l, $w1, $w2, [$b1, $b2, $b3, $b4, $b5, $b6, $b7, $b8])
    };
}

pub const IID_BASE: MpGuid = mp_guid!(
    0xb2f76848, 0xfb04, 0x4cfc, 0x9e, 0x5a, 0xb5, 0xe4, 0xfd, 0x47, 0x47, 0xca
);
pub const IID_UNDO: MpGuid = mp_guid!(
    0xe9200b48, 0xfee7, 0x4332, 0x98, 0x11, 0xe4, 0xb6, 0x3b, 0x96, 0x50, 0x8f
);
pub const IID_NOTE: MpGuid = mp_guid!(
    0x7bf6174e, 0xddf7, 0x498c, 0xae, 0x30, 0xa9, 0x2d, 0xce, 0x2b, 0x94, 0xd9
);
pub const IID_EVENT: MpGuid = mp_guid!(
    0x4607aa39, 0x1ad7, 0x4fae, 0x90, 0x0f, 0xd7, 0x86, 0x95, 0x3e, 0x2f, 0x1f
);
pub const IID_EVENT_TLS: MpGuid = mp_guid!(
    0x8a7c2e24, 0xf055, 0x4f41, 0xa7, 0xa4, 0x2f, 0x73, 0x69, 0xe6, 0x33, 0xfe
);
pub const IID_EVENT_NSM: MpGuid = mp_guid!(
    0xf1656785, 0x2f74, 0x4efb, 0x8a, 0xbb, 0x90, 0x16, 0x94, 0x0e, 0xfa, 0xd1
);
pub const IID_EVENT_BPM: MpGuid = mp_guid!(
    0xd25bee92, 0xca99, 0x4d62, 0xa9, 0x61, 0x26, 0xbf, 0xfd, 0x5b, 0x6e, 0xee
);
pub const IID_EVENT_BEAT: MpGuid = mp_guid!(
    0xf4c8269e, 0x0c08, 0x46a8, 0x96, 0xf6, 0xf2, 0xaa, 0xaf, 0x78, 0x64, 0x2d
);
pub const IID_CHART: MpGuid = mp_guid!(
    0x6db9dd3f, 0x631b, 0x4496, 0xbf, 0x5b, 0x53, 0x5f, 0xf1, 0xf0, 0xee, 0xb0
);
pub const IID_DOCUMENT: MpGuid = mp_guid!(
    0xf90dce72, 0x71ca, 0x412d, 0x94, 0xce, 0xb4, 0xae, 0x89, 0xfe, 0x5a, 0x12
);
pub const IID_CONTEXT: MpGuid = mp_guid!(
    0x577c993c, 0x679c, 0x4ecd, 0xb2, 0x05, 0x31, 0xc6, 0x4e, 0x57, 0x4d, 0xb2
);
pub const IID_COMMAND: MpGuid = mp_guid!(
    0x2e868db6, 0xff3a, 0x46c8, 0x96, 0x09, 0x18, 0xea, 0x41, 0x94, 0x7d, 0x42
);
